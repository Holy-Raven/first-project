...
#### Входные данные:
* n - целое число, количество момментор работы приложения для которых записана статистика.
...
* в следующих m строках описание периодов, которй состоит из двух чисел, номера первого и последнего момента.
#### Выходные данные:
* вывести m строк, каждая из которых соотвествует периоду, интересующую Николая. Вывести YES - если указанный период
